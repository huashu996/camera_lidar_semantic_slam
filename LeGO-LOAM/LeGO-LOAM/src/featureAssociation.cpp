...
public:
    ...
    FeatureAssociation(): //构造函数消息回调  接收上一步发布的消息
        ...
        Lookseg=nh.advertise<sensor_msgs::PointCloud2>("/new_segmented_cloud", 1);
        //发布点云用于建图
...
//×××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××××
    ...
    void adjustDistortion()
    {
        ...
        for (int i = 0; i < cloudSize; i++) {
            ...
            segmentedCloud->points[i] = point;//segmentedCloud坐标转换完毕
...
//************************************************************************************************************************排除
    ...
    void publishCloud()
    {
        ...
        // 2、稍微平滑的线特征   laser_cloud_less_sharp
        ...
        // 4、地面面特征 和 其他没被选择的点   laser_cloud_less_flat    颜色不正常
	    ...
	    if (Lookseg.getNumSubscribers() != 0){
	        pcl::toROSMsg(*segmentedCloud, laserCloudOutMsg);
	        laserCloudOutMsg.header.stamp = cloudHeader.stamp;
	        laserCloudOutMsg.header.frame_id = "/camera";
	        Lookseg.publish(laserCloudOutMsg);
	    }
    }
    ...
    void adjustOutlierCloud(){
        ...
        for (int i = 0; i < cloudSize; ++i)
        {
            ...
            point.r = outlierCloud->points[i].r;
            point.g = outlierCloud->points[i].g;
            point.b = outlierCloud->points[i].b;
    ...
    void publishCloudsLast(){
        ...
        if (frameCount >= skipFrameNum + 1) {
            ...
            frameCount = 0;
            // 调整坐标系，x=y,y=z,z=x   outlier_cloud_last
            adjustOutlierCloud();   
